...
void Application::setup() {
	running = Graphics::openWindow("Particles with random initial velocities");//openWindow();
...
void Application::update() {
	...
	for (auto particle : particles) {
		...
		Vec2 friction = Force::generateFrictionForce(*particle, 4);
